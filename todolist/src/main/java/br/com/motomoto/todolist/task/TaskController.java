package br.com.motomoto.todolist.task;
...
import br.com.motomoto.todolist.utils.Utils;
...
public class TaskController {
	...
	public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id, HttpServletRequest request) {
		...
		var taskUppdated = this.taskRepository.save(task);
		return ResponseEntity.ok().body(taskUppdated);
